 ...
 * @author Drew
 */
public class BuildRoadHandler extends ServerHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        else
        {
            ...
            BuildRoadParam param = g.fromJson(input, BuildRoadParam.class);
            GameModelResponse response = ServerFacade.buildRoad(param, gameId);
