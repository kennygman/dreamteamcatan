 ...
 * @author Drew
 */
public class BuildSettlementHandler extends ServerHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        else
        {
            ...
            BuildSettlementParam param = g.fromJson(input, BuildSettlementParam.class);
            GameModelResponse response = ServerFacade.buildSettlement(param, gameId);
