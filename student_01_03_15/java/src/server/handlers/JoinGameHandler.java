...
public class JoinGameHandler extends ServerHandler implements HttpHandler
{
	...
	public void handle(HttpExchange exchange) throws IOException
	{
		...
		PreGameCookie cookieParam = null; // loginParam uses username, but the cookie uses name 
		try
		{
		...
		CredentialsParam loginParam = new CredentialsParam(cookieParam.getName(), cookieParam.getPassword());
