...
public class JoinGameHandler extends ServerHandler implements HttpHandler
{
	...
	public void handle(HttpExchange exchange) throws IOException
	{
		...
		try
		{
			...
			PreGameCookie cookieParam = null; // loginParam uses username, but
												// the
												// cookie uses name
			...
			{
				User user = new User(loginResponse.getPlayerInfo().getId(),
						loginParam.getUser(), loginParam.getPassword());
				JoinGameParam joinParam = g
						.fromJson(input, JoinGameParam.class);
