 ...
 * @author Drew
 */
public class PlayMonopolyHandler extends ServerHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        else
        {
            ...
            PlayMonopolyParam param = g.fromJson(input, PlayMonopolyParam.class);
            GameModelResponse response = ServerFacade.playMonopolyCard(param, gameId);
