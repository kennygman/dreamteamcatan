 ...
 * @author Drew
 */
public class PlaySoldierHandler extends ServerHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        else
        {
            ...
            PlaySoldierParam param = g.fromJson(input, PlaySoldierParam.class);
            GameModelResponse response = ServerFacade.playSoldierCard(param, gameId);
