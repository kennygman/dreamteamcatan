 ...
 * @author Drew
 */
public class RobPlayerHandler extends ServerHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        else
        {
            ...
            GameModelResponse response = ServerFacade.robPlayer(param, gameId);
	...
	System.out.println("RobPlayerHandler Response: " + responseBody);
